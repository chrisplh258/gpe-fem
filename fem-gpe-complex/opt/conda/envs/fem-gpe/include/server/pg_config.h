...
#define CONFIGURE_ARGS " '--prefix=/opt/conda/envs/fem-gpe' '--with-libraries=/opt/conda/envs/fem-gpe/lib' '--with-includes=/opt/conda/envs/fem-gpe/include' '--enable-thread-safety' '--with-gssapi' '--with-icu' '--with-ldap' '--with-libxml' '--with-libxslt' '--with-lz4' '--with-zstd' '--with-openssl' '--with-uuid=e2fs' '--with-system-tzdata=/opt/conda/envs/fem-gpe/share/zoneinfo' 'PG_SYSROOT=undefined' 'build_alias=x86_64-conda-linux-gnu' 'host_alias=x86_64-conda-linux-gnu' 'CC=x86_64-conda-linux-gnu-cc' 'CFLAGS=-march=nocona -mtune=haswell -ftree-vectorize -fPIC -fstack-protector-strong -fno-plt -O2 -ffunction-sections -pipe -isystem /opt/conda/envs/fem-gpe/include -fdebug-prefix-map=/home/conda/feedstock_root/build_artifacts/postgresql-split_1763564713763/work=/usr/local/src/conda/postgresql-split-17.7 -fdebug-prefix-map=/opt/conda/envs/fem-gpe=/usr/local/src/conda-prefix' 'LDFLAGS=-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,--disable-new-dtags -Wl,--gc-sections -Wl,--allow-shlib-undefined -Wl,-rpath,/opt/conda/envs/fem-gpe/lib -Wl,-rpath-link,/opt/conda/envs/fem-gpe/lib -L/opt/conda/envs/fem-gpe/lib' 'CPPFLAGS=-DNDEBUG -D_FORTIFY_SOURCE=2 -O2 -isystem /opt/conda/envs/fem-gpe/include' 'CXX=x86_64-conda-linux-gnu-c++' 'CXXFLAGS=-fvisibility-inlines-hidden -fmessage-length=0 -march=nocona -mtune=haswell -ftree-vectorize -fPIC -fstack-protector-strong -fno-plt -O2 -ffunction-sections -pipe -isystem /opt/conda/envs/fem-gpe/include -fdebug-prefix-map=/home/conda/feedstock_root/build_artifacts/postgresql-split_1763564713763/work=/usr/local/src/conda/postgresql-split-17.7 -fdebug-prefix-map=/opt/conda/envs/fem-gpe=/usr/local/src/conda-prefix' 'CPP=/home/conda/feedstock_root/build_artifacts/postgresql-split_1763564713763/_build_env/bin/x86_64-conda-linux-gnu-cpp' 'PKG_CONFIG_PATH=/opt/conda/envs/fem-gpe/lib/pkgconfig'"
...
#define PG_VERSION_STR "PostgreSQL 17.7 on x86_64-conda-linux-gnu, compiled by x86_64-conda-linux-gnu-cc (conda-forge gcc 14.3.0-7) 14.3.0, 64-bit"
