...
#define PETSC_PKG_MPICH_VERSION_MINOR 3
#define PETSC_PKG_MPICH_VERSION_SUBMINOR 0
...
#define PETSC_PKG_HWLOC_VERSION_SUBMINOR 2
...
#define PETSC_PKG_HYPRE_VERSION_MINOR 32
...
#define PETSC_PKG_SUITESPARSE_VERSION_MINOR 10
#define PETSC_PKG_SUITESPARSE_VERSION_SUBMINOR 1
...
#define PETSC_PKG_SUPERLU_DIST_VERSION_MAJOR 9
#define PETSC_PKG_SUPERLU_DIST_VERSION_MINOR 1
#define PETSC_PKG_SUPERLU_DIST_VERSION_SUBMINOR 0
#define PETSC_PKG_SUPERLU_DIST_VERSION_ PETSC_PKG_SUPERLU_DIST_VERSION_EQ

#define PETSC_PKG_SUPERLU_DIST_VERSION_EQ(MAJOR,MINOR,SUBMINOR)         \
      ((PETSC_PKG_SUPERLU_DIST_VERSION_MAJOR    == (MAJOR)) &&          \
       (PETSC_PKG_SUPERLU_DIST_VERSION_MINOR    == (MINOR)) &&          \
       (PETSC_PKG_SUPERLU_DIST_VERSION_SUBMINOR == (SUBMINOR)))

#define PETSC_PKG_SUPERLU_DIST_VERSION_LT(MAJOR,MINOR,SUBMINOR)         \
       (PETSC_PKG_SUPERLU_DIST_VERSION_MAJOR  < (MAJOR) ||              \
        (PETSC_PKG_SUPERLU_DIST_VERSION_MAJOR == (MAJOR) &&             \
         (PETSC_PKG_SUPERLU_DIST_VERSION_MINOR  < (MINOR) ||            \
          (PETSC_PKG_SUPERLU_DIST_VERSION_MINOR == (MINOR) &&           \
...
#define PETSC_PKG_SUPERLU_DIST_VERSION_LE(MAJOR,MINOR,SUBMINOR)         \
       (PETSC_PKG_SUPERLU_DIST_VERSION_LT(MAJOR,MINOR,SUBMINOR) ||      \
        PETSC_PKG_SUPERLU_DIST_VERSION_EQ(MAJOR,MINOR,SUBMINOR))

#define PETSC_PKG_SUPERLU_DIST_VERSION_GT(MAJOR,MINOR,SUBMINOR)         \
       ( 0 == PETSC_PKG_SUPERLU_DIST_VERSION_LE(MAJOR,MINOR,SUBMINOR))

#define PETSC_PKG_SUPERLU_DIST_VERSION_GE(MAJOR,MINOR,SUBMINOR)         \
       ( 0 == PETSC_PKG_SUPERLU_DIST_VERSION_LT(MAJOR,MINOR,SUBMINOR))
...
#define PETSC_PKG_PTSCOTCH_VERSION_SUBMINOR 6
