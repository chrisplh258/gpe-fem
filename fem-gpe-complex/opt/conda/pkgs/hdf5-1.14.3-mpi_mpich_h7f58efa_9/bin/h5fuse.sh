...
if [ "$parallel" == "true" ]; then
    ...
    if [ ! -f "${c_src}" ]; then
        gen_mpi
        CC=/home/conda/feedstock_root/build_artifacts/hdf5_1737515513320/_h_env_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placeh/bin/mpicc
        ${CC} "${c_src}" -o "${c_exec}"
    fi
    wait
    rank_size=$(./"${c_exec}")
