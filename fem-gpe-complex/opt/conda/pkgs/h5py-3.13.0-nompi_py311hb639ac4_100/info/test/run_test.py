#  tests for h5py-3.13.0-nompi_py311hb639ac4_100 (this is a generated file);
print('===== testing package: h5py-3.13.0-nompi_py311hb639ac4_100 =====');
...
print('===== h5py-3.13.0-nompi_py311hb639ac4_100 OK =====');
print("import: 'h5py'")
import h5py
